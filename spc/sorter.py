...
def grab_data_from_table(artist_name):
    """
    Sorts through the raw API calls from the spotify db, converts from str artist_name.replace(' ', '_')to json,
    searches in the dict for the values we need, assigns appropriate keys to the values. :return: Pandas Data Frame
